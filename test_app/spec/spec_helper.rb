...
VCR.configure do |config|
  ...
  # Necessario para o Capybara Chromium Headless
  config.ignore_localhost = true
end

# Capybara Chromium Headless
...
RSpec.configure do |config|
  # FactoryBot Lint !! Pode diminuir a performance dos testes. Checar boas praticas na documentacao !!
